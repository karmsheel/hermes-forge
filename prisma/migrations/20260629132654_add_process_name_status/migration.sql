...
INSERT INTO "new_Process" ("automationScore", "businessId", "businessValue", "complexity", "createdAt", "department", "description", "diagramMermaid", "diagramUpdatedAt", "estimatedTimeSaved", "id", "inputs", "manualSteps", "name", "outputs", "repetition", "status", "trigger", "updatedAt") SELECT "automationScore", "businessId", "businessValue", "complexity", "createdAt", "department", "description", "diagramMermaid", "diagramUpdatedAt", "estimatedTimeSaved", "id", "inputs", "manualSteps", "name", "outputs", "repetition", "status", "trigger", "updatedAt" FROM "Process";
DROP TABLE "Process";
