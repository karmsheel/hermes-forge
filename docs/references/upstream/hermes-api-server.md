<!--
  Archived copy of upstream Hermes Agent API Server docs.
  Source: https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/api-server.md
  Raw:    https://raw.githubusercontent.com/NousResearch/hermes-agent/main/website/docs/user-guide/features/api-server.md
  Fetched: 2026-07-21
  Do not edit by hand — re-fetch when re-auditing. Analysis lives in HERMES_API_SERVER.md.
-->
---
sidebar_position: 14
title: "API Server"
